...
{
  //TRIGGER_PIN = BDPIN_GPIO_1;
  //ECHO_PIN = BDPIN_GPIO_2;
...
{
	//NewPing sonar(int a1 = 50,int a2 = 51, int a3 = 200);
	NewPing s1(50, 51, 200);	
	//unsigned int uS = 10; //sonar().ping();
	float uS = s1.ping();
	//unsigned int uS = s1.ping();
	pinMode(ECHO_PIN,OUTPUT);
	digitalWrite(ECHO_PIN,LOW);
	pinMode(ECHO_PIN,INPUT);
	sonar_data_ = uS / US_ROUNDTRIP_CM;
}
